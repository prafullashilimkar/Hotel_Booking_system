<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainBooking.aspx.cs" Inherits="Hotel_Booking_System.Hotel.MainBooking" %>
...
<div class="reg">
         <asp:Label ID="lblHotelName" runat="server" Text="Hotel Name: " Font-Bold="True" ForeColor="White"/>
		<h1>Book Your Suite!<%--asp:LinkButton ID="LinkButton_Logout" runat="server" Font-Bold="True" 
	...
	<script>
        function validateDate() {
            var input = document.getElementById('<%= datepicker1.ClientID %>');
		...
		<div class="book-pag">
			...
			<div class="book-pag-frm1">
                ...
                <asp:TextBox ID="datepicker1" class="date" runat="server" value="Date"  onblur="validateDate();" required=""></asp:TextBox>
			...
			<div class="book-pag-frm2">
				...
				<asp:TextBox ID="datepicker2" class="date"  runat="server" value="Date" onfocus="this.value = '';" onblur="validateDate();" required=""></asp:TextBox>
				<%--<input class="date" id="datepicker2" type="text" value="Date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">--%>       </script>
			</div>
		<div class="clear"></div>
		</div>	
		...
		<div class="food">
			<h2>Full name</h2>
               <asp:TextBox ID="txt_fulname" runat="server" Width="437px" placeholder="Full Name" ></asp:TextBox>
		</div>
		...
		<div class="submit">
                <asp:Button ID="Bt_submit" runat="server" class="book" Text="Book Now" 
                    ...
                    Font-Size="Medium" ForeColor="White" Width="67px" OnClick="Button_print_Click1" />
